...
Summary improvement: streaming summarize with structured in-depth breakdown.

What changed:
  - summarize_text() now calls /summarize/stream and returns a generator
  - st.write_stream() displays the breakdown word by word inside the expander
  - Summary appears section by section as it generates instead of all at once
